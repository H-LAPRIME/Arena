...
export const authApi = {
  ...
  checkLoginEmail: (email: string) =>
    apiFetch(`/api/auth/check-login-email?email=${encodeURIComponent(email)}`),
...
export const leaguesApi = {
  ...
  newSeason: (id: string) => apiFetch(`/api/admin/leagues/${id}/new-season`, { method: "POST" }),

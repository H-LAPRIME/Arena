  ...
  return (
    <div className="page-container">
      <div className="page-header" style={{ textAlign: "center" }}>
        <h1 className="page-title"><TrophyIcon /> Hall of Fame</h1>
      ...
      {lord ? (
        <div className="card" style={{ textAlign: "center", padding: "48px", marginBottom: "32px",
          ...
          <div style={{ color: "var(--gold)", marginBottom: "16px", display: "flex", justifyContent: "center" }}><CrownIcon /></div>
          <div className="lord-badge" style={{ fontSize: "14px", marginBottom: "16px" }}><TrophyIcon /> LORD OF THE GAME</div>
        ...
        <div className="card" style={{ textAlign: "center", padding: "48px", marginBottom: "32px" }}>
          <div style={{ color: "var(--text-muted)", marginBottom: "16px", display: "flex", justifyContent: "center" }}><CrownIcon /></div>
      ...
      <div className="card" style={{ marginBottom: "32px" }}>
        <div className="card-header"><span className="card-title"><CrownIcon /> Palmarès des joueurs</span></div>
      ...
      {completedLeagues.length > 0 && (
        <div className="card">
          <div className="card-header"><span className="card-title"><ScrollIcon /> Historique des Ligues</span></div>
              ...
              return (
                <div key={s.id} className="match-card played">
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                    <span style={{ color: "var(--gold)", display: "flex" }}><CrownIcon /></span>

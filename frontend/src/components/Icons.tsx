...
export const CrownIcon = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 20h20"/><path d="m4 16 4-8 4 4 4-8 4 8"/></svg>
);
...
export const GamepadIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="6" y1="12" x2="10" y2="12"/><line x1="8" y1="10" x2="8" y2="14"/><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="15.5" cy="15.5" r=".5" fill="currentColor"/><circle cx="15.5" cy="8.5" r=".5" fill="currentColor"/><circle cx="18.5" cy="12" r=".5" fill="currentColor"/></svg>
);

export const BallIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polygon points="12 6 16 9 14.5 14 9.5 14 8 9 12 6"/><path d="m8 9-4-.5"/><path d="m16 9 4-.5"/><path d="m9.5 14-2.5 4"/><path d="m14.5 14 2.5 4"/></svg>
);

export const MedalIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7.2 2h9.6l-2.4 6h-4.8L7.2 2Z"/><circle cx="12" cy="15" r="6"/><path d="m10.4 15.6 1.1 1.1 2.4-3"/></svg>
);

export const ScrollIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 21h9a3 3 0 0 0 3-3V5a2 2 0 0 0-2-2H7a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3Z"/><path d="M8 21a3 3 0 0 1-3-3h9a3 3 0 0 0 3-3V3"/><path d="M8 7h5"/><path d="M8 11h5"/></svg>
);
...
export const HistoryIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v5h5"/><path d="M21 21v-5h-5"/><path d="M5.5 5.5a9 9 0 0 1 13 13"/><path d="M18.5 5.5a9 9 0 0 0-13 13"/></svg>
);

export const HandshakeIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 22a2 2 0 1 0 0-4 2 2 0 0 0 0 4z"/><path d="M14 13l-2-2 2-2"/><path d="M18 10l-2 2 2 2"/><path d="M10 10l-2 2 2 2"/><path d="M22 13a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v6z"/></svg>
);
...
export const ArrowLeftIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 5 5 12 12 19"/></svg>
);
